                        ...
                        <div className="grid md:grid-cols-2 text-sm">
                            ...
                            <div className="grid grid-cols-2">
                                ...
                                <div className="px-4 py-2">
                                    <a className="text-blue-800" href={`mailto:${profile.email}`}>{profile.email}</a>
                                </div>
                            </div>
                            <div className="grid grid-cols-2">
                                <div className="px-4 py-2 font-semibold">Address.</div>
                                <div className="px-4 py-2">
                                    { profile.address && profile.address.city && profile.address.street
                                    ? `${profile.address.city} ${profile.address.street}`
                                    : <a href="/auth/addAdress">Dodaj swoj adress</a> }
                                </div>
                            </div>
                        </div>
                    </div>
